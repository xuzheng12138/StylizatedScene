...
half4 FragmentShaderWork(V2F input) : SV_TARGET
{
    ...
    half3 Albedo = MainAlbedo;
    N = MainNormalWS;
    half Metallic = MainMetallicGloss.r + _MetallicScale;
    half Smoothness = MainMetallicGloss.a * _SmoothnessScale;
    half Occlusion = pow(max(MainMetallicGloss, 0.0001), _OcclusionScale);
